ilihan = document.getElementById("pilihan");
const niconstlaiAwal = document.getElementById("nilaiAwal");
    ...
    if (nilaiAwal.value % 2 === 1) {
      ...
      for (count; count <= nilaiAkhir.value; count++) {
        ...
        if (count % 2 == 0) {
          ...
          cetakHasil.innerText = BilanganGenap; $_arrGenap.join(", ");
        }
      }
    }
    ...
    if (nilaiAwal.value % 2 === 0) {
      ...
      for (count; count <= nilaiAkhir.value; count++) {
        ...
        if (count % 2 == 1) {
          ...
          // Memberikan method join agar koma nya ada spasi
          cetakHasil.innerText = BilanganGajil ; {arrGanjil.join(", ")};
        }
      }
    }
  }
